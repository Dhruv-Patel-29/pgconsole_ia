...
InfoAnalytica supports multiple authentication methods to secure access to your database console.
...
To run InfoAnalytica without authentication (not recommended for production), simply omit the `[auth]` section from your configuration file.
